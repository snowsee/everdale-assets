...
void main(void)
{
	...
	v_cloudUv *= u_cloudshadow1_scale;
	v_cloudUv += u_cloudshadow1_offset;
	v_cloudUv = vec2( v_cloudUv.x * u_cloudshadow1_rot_sc.x - v_cloudUv.y * u_cloudshadow1_rot_sc.y, v_cloudUv.x * u_cloudshadow1_rot_sc.y + v_cloudUv.y * u_cloudshadow1_rot_sc.x );
#endif
